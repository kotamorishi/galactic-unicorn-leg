...
var _bt=0,_vt=0;
function setBright(v){document.getElementById('q-bright-v').textContent=v+'%';clearTimeout(_bt);_bt=setTimeout(function(){api('POST','/api/system/brightness',{brightness:parseInt(v)})},1000)}
